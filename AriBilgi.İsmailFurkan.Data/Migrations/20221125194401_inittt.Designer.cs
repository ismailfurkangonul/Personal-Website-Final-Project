...
namespace AriBilgi.İsmailFurkan.Data.Migrations
{
    ...
    [Migration("20221125194401_inittt")]
            ...
            modelBuilder.Entity("AriBilgi.IsmailFurkan.Entities.Concrete.About", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 25, 22, 44, 1, 72, DateTimeKind.Local).AddTicks(3541),
                            Explain = "Yazılım",
            ...
            modelBuilder.Entity("AriBilgi.IsmailFurkan.Entities.Concrete.Certificates", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 25, 22, 44, 1, 73, DateTimeKind.Local).AddTicks(7836),
                            Title = "Certificates"
                        });
                });
            ...
            modelBuilder.Entity("AriBilgi.IsmailFurkan.Entities.Concrete.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 25, 22, 44, 1, 74, DateTimeKind.Local).AddTicks(5233),
