        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Explain = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Abouts",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "Explain", "Name" },
                values: new object[] { 1, 1, new DateTime(2022, 11, 23, 17, 39, 8, 551, DateTimeKind.Local).AddTicks(3603), "Yazılım", "İsmail Furkan Gönül" });
        }
